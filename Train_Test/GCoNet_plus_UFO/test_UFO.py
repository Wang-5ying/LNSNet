...
from codes.GCoNet_FIRST.修改意见添加对比方法.UFO.model_image import build_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--size',
                        ...
                        type=int,
                        help='input size')
    parser.add_argument('--ckpt', default='/media/wby/shuju/ckpt2333/best_ep8_Smeasure0.3954.pth', type=str,  # 71-8627
                        help='model folder')
