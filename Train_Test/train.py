...
parser.add_argument('--size',
                    ...
                    type=int,
                    help='input size')
parser.add_argument('--ckpt_dir', default="/media/wby/shuju/ckpt23", help='Temporary folder')
...
model2.load_pre("/media/wby/shuju/seg_pre/segformer.b0.512x512.ade.160k.pth")
