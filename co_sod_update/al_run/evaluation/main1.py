...
def main(cfg):
    ...
    for method in method_names:
        ...
        print("epochs", os.path.join(cfg.pred_dir, method), epochs)
        for epoch in epochs:
            continue_eval = True
            for dataset in dataset_names:
                loader = EvalDataset(
...
if __name__ == "__main__":
    ...
    parser.add_argument('--methods', type=str, default='GICD')
    parser.add_argument('--datasets', type=str,
                        default='RGBD_CoSal1k')  # +CoSOD3k+Cosal2015 RGBD_CoSal1k' RGBD_CoSal150 RGBD_CoSeg183
    parser.add_argument('--gt_dir', type=str, default='/storage/student4/wby_data/gts', help='GT')
    parser.add_argument('--pred_dir', type=str, default='/storage/student4/wby_data/pred_dir',
                        help='predictions')  # /home/map/Alchemist/COA/COA_RGBD_SOD/ckpt/Thrid_models
    parser.add_argument('--output_dir', type=str, default='/storage/student4/wby_data/main_py_output',
                        help='saving measurements here.')
    parser.add_argument('--output_figure', type=str, default='/storage/student4/wby_data/main_py_output',
                        help='saving figures here.')
