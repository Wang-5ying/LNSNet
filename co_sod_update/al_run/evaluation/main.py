...
def main(cfg):
    ...
    parser.add_argument('--methods', type=str, default='wby_data')
    ...
    parser.add_argument('--pred_dir', type=str, default='/storage/student4/', help='predictions')# /home/map/Alchemist/COA/COA_RGBD_SOD/ckpt/Thrid_models
    parser.add_argument('--output_dir', type=str, default='/storage/student4/wby_data/main_py_output', help='saving measurements here.')
    parser.add_argument('--output_figure', type=str, default='/storage/student4/wby_data/main_py_output', help='saving figures here.')
