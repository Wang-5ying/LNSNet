...
# from COA_RGBD_SOD.al.models.First_model.KD_Teacher_New_Test_Shunted_B import RGBD_sal as CoNet
# from COA_RGBD_SOD.al.models.Third_model.MAPNet import CoNet
from Co_SOD.LNSNet.teacher import M as CoNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--size',
                        ...
                        type=int,
                        help='input size')
    parser.add_argument('--ckpt', default='/storage/student4/wby_data/Fourth_model_Teacher_weights/best_ep49_Smeasure0.8732.pth', type=str, #权重路径
                        help='model folder')
    parser.add_argument('--pred_dir',
                        default='/storage/student4/wby_data/pred_dir', # 输出预测图路径
