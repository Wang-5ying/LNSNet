...
from COA_RGBD_SOD.al.models.CoNet import CoNet
...
parser.add_argument('--ckpt_dir',
                    default="/media/map/fba69cc5-db71-46d1-9e6d-702c6d5a85f4/Alchemist/COA/COA_RGBD_SOD/ckpt/Fourth_models/CoNet_shunted_s_co/Pth/",
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        #
        loss1 = CE(return_values[0], gts) + IOU(F.sigmoid(return_values[0]), gts)
        loss2 = CE(return_values[1], gts) + IOU(F.sigmoid(return_values[1]), gts)
