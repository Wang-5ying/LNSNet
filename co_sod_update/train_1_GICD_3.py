...
parser.add_argument('--ckpt_dir',
                    default="/storage/student4/wby_data/comparemethod_output/GICD/3",
...
parser.add_argument('--val_dir',
                    default='/storage/student4/wby_data/comparemethod_output/GICD/3/tmp4val/',
                    type=str,
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        loss1 = IOU(return_values[-1][-1], gts)
        loss2 = IOU(return_values[-1][-2], gts)
        loss3 = IOU(return_values[-1][-3], gts)
        loss4 = IOU(return_values[-1][-4], gts)
    ...
    for testset in testsets[:1]:
        ...
        for batch in test_loader:
            ...
            with torch.no_grad():
                ...
                scaled_preds = model(inputs, depths)[-1][-1]
