...
parser.add_argument('--ckpt_dir',
                    default="/storage/student4/wby_data/comparemethod_output/TCNet/4",
...
parser.add_argument('--val_dir',
                    default='/storage/student4/wby_data/comparemethod_output/TCNet/4/tmp4val/',
                    type=str,
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        S_3_pred, S_4_pred, S_5_pred, S_g_pred = model(image_group=inputs, is_training=True)
