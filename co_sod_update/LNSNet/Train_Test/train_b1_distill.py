...
from codes.bayibest82segformerbest.best.distill.student.student2_b1 import M as S
...
parser.add_argument('--epochs', default=100, type=int)  # 320
...
parser.add_argument('--size',
                    ...
                    type=int,
                    help='input size')
parser.add_argument('--ckpt_dir', default="/media/wby/shuju/ckpt2", help='Temporary folder')
...
model2.load_pre("/media/wby/shuju/seg_pre/segformer.b1.512x512.ade.160k.pth")
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        return_values, r, d, xdecode = model2(inputs, depths)
        # for i in rte:
        #     print("rte", i.size())
        # for i in dte:
        #     print("dte", i.size())
        ...
        loss_sal = (loss_sal1 + loss_sal2 + loss_sal3) *10 + kl + loss_sal4
