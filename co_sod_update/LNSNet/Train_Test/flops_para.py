...
from Co_SOD.LNSNet.student.student2_b3 import M
...
def main(args):
    ...
    for testset in args.testsets.split('+'):
        ...
        test_loader = get_loader(
            test_img_path, test_gt_path, test_depth_path, test_gt_path,  args.size, 1, istrain=False,
        ...
        b = torch.randn(3,1,256,256).cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_dir',
                        default='/storage/student4/wby_data/pred_dir',
