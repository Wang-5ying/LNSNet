...
class Eval_thread():
    def __init__(self, loader, method='', dataset='', output_dir='', epoch='', cuda=True):
        ...
        self.dataset2smeasure_bottom_bound = {'CoCA': 0.673, 'CoSOD3k': 0.802, 'Cosal2015': 0.845, 'RGBD_CoSal150': 0.600, "RGBD_CoSal1k": 0.875, "RGBD_CoSeg183":0.700}      # S_measures of GCoNet_plus
