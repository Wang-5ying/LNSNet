...
class S(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        cfg_path = '/home/wby/PycharmProjects/Transformer_backbone/SegFormerguanfnag/local_configs/segformer/B2/segformer.b2.512x512.ade.160k.py'
