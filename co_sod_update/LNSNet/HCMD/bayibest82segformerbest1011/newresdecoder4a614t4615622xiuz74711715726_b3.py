...
from third.mix_transformer import mit_b3
...
class AM2(nn.Module):
    def __init__(self, in_channel1, in_channel2, in_channel4, in_channel5):  #rgm1, rgm2, rlayer_features[1], rlayer_features[0]
        ...
        self.gcn3 = Gru(96, 96)
        self.gcn4 = Gru(96, 96)
    def forward(self, x1, x2, x4, x5): # gm1, rgm2, rte[0], rte[1]
        gm1 = self.u1(x1)
        gm2 = self.u2(x2)
        r2 = self.u4(x4)
        r3 = self.u42(x5) ###84
        ...
        res1 = self.gcn1(gm1,gm2)  ##yuanben douyong1  # br(r0) r3(r1)
