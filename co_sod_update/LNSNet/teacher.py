...
from Co_SOD.LNSNet.HCMD.bayibest82.baseapi.newapii711715 import BasicConv2d, node, CA, GM2
...
# from Co_SOD.LNSNet.SegFormer.mmseg.models.backbones.mix_transformer import mit_b5
from Co_SOD.LNSNet.mix_transformer import mit_b5
# from mmseg.models import build_segmentor
...
class M(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.gm1 = CAAM_WBY(512, 1, [32, 32], norm_layer=nn.BatchNorm2d)   # feat_in, num_classes, bin_size, norm_layer):
    ...
    def forward(self, r, d):
        ...
        res2 = res2 * F.interpolate(guide3, size=32)
        ...
        # else:
        #     return res2, res3, res3
        #     return res2, res4, res4

        # if distill
        return srte, sdte, decode, returnvalues
