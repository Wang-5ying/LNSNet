...
from codes.GCoNet_FIRST.修改意见添加对比方法.TCNet_main.t2t_vit import T2t_vit_t_14
from codes.GCoNet_FIRST.修改意见添加对比方法.TCNet_main.transformer_block import Block, get_sinusoid_encoding
from timm.models.layers import trunc_normal_
from codes.GCoNet_FIRST.修改意见添加对比方法.TCNet_main.token_performer import Token_performer
...
class ICNet(nn.Module):
    def __init__(self, channel=64):
        ...
        parser.add_argument('--pretrained_model', default='/home/wby/Downloads/80.7_T2T_ViT_t_14.pth.tar',
    ...
    def forward(self, r, d, is_training):
        rgb_fea_1_16, rgb_fea_1_8, rgb_fea_1_4 = self.rgb_backbone(r)
        rgb_fea_1_16_1, rgb_fea_1_8_1, rgb_fea_1_4_1 = self.rgb_backbone(d)
        rgb_fea_1_16 = rgb_fea_1_16 + rgb_fea_1_16_1
        ...
        conv1_2 = self.vgg(r, 'conv1_1', 'conv1_2_mp')  # shape=[N, 64, 224, 224]
