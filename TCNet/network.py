...
from Co_SOD.TCNet.t2t_vit import T2t_vit_t_14
from Co_SOD.TCNet.transformer_block import Block, get_sinusoid_encoding
from timm.models.layers import trunc_normal_
from Co_SOD.TCNet.token_performer import Token_performer
...
class ICNet(nn.Module):
    def __init__(self, channel=64):
        ...
        parser.add_argument('--pretrained_model', default='/storage/student4/wby_data/pretrain_weights/80.7_T2T_ViT_t_14.pth.tar',
...
if __name__ == '__main__':
    ...
    c = torch.randn(5, 1, 224, 224).cuda()

    model = ICNet()
    model.cuda()
    out = model(image_group=a, is_training=False)
